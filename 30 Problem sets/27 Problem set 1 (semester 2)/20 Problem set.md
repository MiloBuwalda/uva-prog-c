...
* The deadline for this problem set is Friday **February 7th, 2014** (16:00).
...
* Notice how gedit adds syntax highlighting (color) as you type. Those colors
  are not actually saved inside of the file itself; they are just added by gedit
...
* Before doing any math, then, you'll probably want to convert the users input
