...
n2 steps in both the best- and worst-case scenarios whereas bubble sort
takes n2 steps in the worst-case scenario, but only n steps in the best-case
scenario.
...
Fall 2011
Scribe Notes
Week 4 Monday: September 26, 2011
Andrew Sellergren
selection sort.2 Even Barack Obama knows that bubble sort isn’t the best
solution.
4
...
recursion. Although it feels like you’re just being a jerk,4 you are in fact
...
Our main method is identical to that of sigma1.c. All that differs is sigma,
...
to O(n2 ), which would take 162 = 256 steps. Already we’re reaping the
benefits.
