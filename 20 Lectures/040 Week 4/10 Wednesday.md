...
lante, a CS professor at Stanford.2
2
...
1 Wii
2 And
Tennis is super important.
a consultant at Google!
2
Computer Science 50
Fall 2011
Scribe Notes
Week 4 Wednesday: September 28, 2011
Andrew Sellergren
a = b;
b = a;
...
in size.3
3 Assuming a 32-bit architecture. If the architecture is 64-bit, then each pointer is 64 bits
in size.
3
Computer Science 50
Fall 2011
...
5 You know that whenever I say that, I’m about to say, “But it doesn’t! (gasp)” Sad how
predictable I am.
5
Computer Science 50
Fall 2011
...
Week 4 Wednesday: September 28, 2011
Andrew Sellergren
Seems to work.6 However, what if we add a snippet of code in to capitalize
...
Anything wrong here?7 Oops, we haven’t asked for any memory for y, so
