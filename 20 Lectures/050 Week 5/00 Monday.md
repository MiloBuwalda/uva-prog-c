...
and Numb3rs offer some unfortunate examples of this.1
...
1 Okay,
I have a bone to pick with David. He did not just make fun of Numb3rs, did he?!?
2
Computer Science 50
Fall 2011
Scribe Notes
...
int *. Pointers typically point to a single data type in particular, so &x
and &y are pointers-to-int.
...
0x08048449 in foo (n=5) at bar.c:33
0x0804828 in main () at bar.c:23
